...
#userform .nav1> .active > a, #userform .nav1 > .active > a:hover, #userform .nav1 > .active > a:focus {
	border: 0;
	background: #F7CA18;
	color: white;
	border-radius: 0;
...
#userform .nav-tabs.nav1> li > a:hover {
	background: #F7CA18;
	color: #FFF;
	border-radius: 0;
	border: 0;
...
<div id="form">
  <div class="container">
    <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-md-8 col-md-offset-2">
      <div id="userform">
        <ul class="nav1" role="tablist" style="display: flex ;gap:3%;">
